...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/sh3/state");
var engine = props.globals.getNode("sim/model/sh3/engine");
...
var turbine = props.globals.getNode("sim/model/sh3/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/sh3/torque-pct", 1);
...
var rotor_step = props.globals.getNode("sim/model/sh3/rotor-step-deg");
