...
reload_guns  = func {
  ...
  if ( ( groundspeed < 5 and engine_rpm < 5 )  
    ...
    gui.popupTip ("Twin ADEN 30mm Cannons reloaded--125 rounds in each cannon.", 5)
    
  } else {
   
    gui.popupTip ("You must be on the ground and engines dead stopped to re-load guns--this requires multiple technicians to complete.",5)
