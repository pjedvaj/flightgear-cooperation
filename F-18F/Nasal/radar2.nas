...
var DisplayRdr        = props.globals.getNode("instrumentation/radar/display-rdr",1);
var AzField           = props.globals.getNode("instrumentation/radar/az-field",1);
var RangeSelected     = props.globals.getNode("instrumentation/radar/range-selected",1);
...
var SwpDisplayWidth   = props.globals.getNode("instrumentation/radar2/sweep-width-m",1);
var RngDisplayWidth   = props.globals.getNode("instrumentation/radar2/range-width-m",1);
var PpiDisplayRadius  = props.globals.getNode("instrumentation/radar2/radius-ppi-display-m",1);
var HudEyeDist        = props.globals.getNode("instrumentation/radar2/hud-eye-dist-m",1);
var HudRadius         = props.globals.getNode("instrumentation/radar2/hud-radius-m",1);
...
var rng_diplay_width  = RngDisplayWidth.getValue(); # Length of the max range vertical width on the
